...
# Other relevant options to do warm-starting with ipopt: mu_init, warm_start_mult_bound_push, warm_start_slack_bound_push,
# warm_start_bound_push. Usually, you want to set these low.
