...
m = biorbd.s2mMusculoSkeletalModel("Modeles/ModeleAv1Muscle.s2mMod")
...
fichierS = open("Resultats/StatesAv1Muscle.txt", "r")
...
fichierU = open("Resultats/ControlsAv1Muscle.txt", "r")
