...
int main (){
    ...
    double x[14] = {1.0000019017476415e-01,	1.0000019174575936e-01,
    ...
    double torques[7]  = {9.9998080119966769e-03, 7.1216513064073284e-01,
                             3.5511034562935351e-01, 7.9053458721196712e-01,
                             1.2090013854635781e-01, 1.1448031133796523e-01,
                             1.7257617394280274e-02};

    double muscles[18] = {1.0851990037012542e-01,	5.1416849841112063e-02,
    ...
    for (unsigned int i=0; i<integrator.nbInterationStep(); ++i) {
        ...
        std::cout << "time = " << 1.6129032258064516e-02 + static_cast<double>(i)*1.6129032258064516e-03 << std::endl;
